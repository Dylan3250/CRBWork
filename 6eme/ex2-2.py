nbList = int(input('Combien voulez-vous entrer de nombre dans le tabeau ?')) # Demande à l'utilisateur combien de nombre doivent être insérés
List = [0] * nbList # Défini un tableau a nbList entrés vide
